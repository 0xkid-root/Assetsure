  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center py-24 overflow-hidden">
      ...
      <div className="container-custom relative z-10 pt-16">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              {words.map((word, i) => (
                <motion.span
                  key={i}
                  className={`inline-block mr-3 ${word === "Real-World" || word === "Assets" ? "text-transparent bg-clip-text bg-gradient-to-r dark:from-amber-400 dark:to-amber-600 from-amber-500 to-amber-700 relative overflow-hidden" : "dark:text-white text-navy-900"}`}
            ...
            >
              <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm border border-white/10 p-3 rounded-lg">
            ...
            >
              <Button className="relative overflow-hidden group bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-navy-900 h-12 px-6 shadow-md shadow-amber-500/20 dark:shadow-amber-500/10 hover:shadow-lg hover:shadow-amber-500/30 hover:-translate-y-0.5 transition-all duration-300">
                ...
                <div className="absolute inset-0 p-8 flex flex-col">
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <span className="text-xs dark:text-amber-400 text-amber-600 bg-amber-100 dark:bg-amber-900/30 px-2 py-0.5 rounded-full font-medium">Spotlight</span>
                        </div>
                        ...
                        <div className="flex justify-between mt-1">
                          ...
                          <span className="dark:text-amber-400 text-amber-600 text-xs font-medium">{assets[currentAsset].percentage}%</span>
                        </div>
                      </motion.div>
                    </AnimatePresence>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {assets.map((asset, index) => (
                      <motion.div 
                        key={asset.name}
                        className={`dark:bg-white/5 bg-navy-900/5 backdrop-blur-sm dark:border-white/10 border-navy-200/50 p-4 rounded-lg ${currentAsset === index ? 'ring-2 dark:ring-amber-500/50 ring-amber-600/50 shadow-lg shadow-amber-500/10' : ''} relative overflow-hidden cursor-pointer`}
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <div className="h-2 w-full dark:bg-gray-700 bg-gray-200 rounded-full overflow-hidden">
                            <div className={`h-full bg-gradient-to-r ${asset.color} w-[${asset.percentage}%] rounded-full`}></div>
                          </div>
                  ...
                  <div className="mt-auto">
                    ...
                    >
                      <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-0 group-hover:opacity-100 animate-shimmer"></span>
        ...
        >
          {[
            { value: "$4.5B+", label: "Assets Tokenized", color: "amber" },
            { value: "32+", label: "Countries Supported", color: "blue" },
            { value: "99.99%", label: "Security Rating", color: "green" },
            { value: "8-16%", label: "Annual Yields", color: "purple" }
          ].map((stat, i) => (
            <motion.div
              key={stat.label}
              initial={{ opacity: 0, y: 20 }}
              ...
              className="flex flex-col items-center justify-center dark:bg-white/5 bg-white/60 backdrop-blur-sm dark:border-white/10 border-navy-200/50 rounded-xl p-6 shadow-lg relative overflow-hidden group hover:border-amber-500/30 transition-all duration-300 hover:shadow-xl hover:shadow-amber-500/10 hover:-translate-y-1"
            >
              <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/20 to-transparent animate-shimmer"></span>
              <h3 className={`text-3xl font-bold text-${stat.color}-500 dark:text-${stat.color}-400 mb-2 group-hover:scale-110 transition-transform duration-300`}>{stat.value}</h3>
